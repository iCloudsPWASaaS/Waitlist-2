...
//extra
/*Route::domain('join.mypropertree.co.uk')->group(function () {
    Route::get('join/{sponsor?}', 'FrontendController@join');
});*/
//Route::get('/', 'FrontendController@index')->name('home');
Route::get('/', 'FrontendController@join')->name('join.sponsor');
Route::post('submit-form', 'Auth\RegisterController@join')->name('form.submit');
...
Route::group(['middleware' => ['guest']], function () { 
    ...
    Route::get('join/{sponsor?}', 'FrontendController@join')->name('join.sponsor'); //extra
});
...
Route::group(['middleware' => ['auth', 'Maintenance'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::middleware('userCheck')->group(function () {
        //Route::middleware('kyc')->group(function () {
            ...
            Route::post('addFundConfirms', 'PaymentController@depositConfirms')->name('addFund.confirms');
            ...
            //extra
            Route::get('/cart', 'User\HomeController@investPropertyCart')->name('invest-property-cart');
            Route::post('/cart-submit', 'User\HomeController@investPropertyCartSubmit')->name('invest-property-cart-submit');
            Route::post('/cart-remove', 'User\HomeController@investPropertyCartRemove')->name('invest-property-cart-remove');
            Route::post('/premium_user', 'User\HomeController@premiumUser')->name('premium_user');
            Route::post('search-property-dashboard', 'User\HomeController@searchPropertyDashboard')->name('search-property-dashboard');
            Route::post('search-property-dashboard2/{id}', 'User\HomeController@searchPropertyDashboard')->name('search-property-dashboard2');
            Route::post('/reserve-property/{id}', 'User\HomeController@reserveProperty')->name('reserve-property');
            ...
            Route::get('/share-market/{type?}', 'User\HomeController@shareMarket')->name('shareMarket'); //extra
            ...
            //Route::get('/referral', 'User\HomeController@referral')->name('referral'); //extra
    ...
    Route::group(['prefix' => 'subscription', 'as' => 'subscription.'], function () {
        Route::get('/', 'User\SubscriptionController@index')->name('index');
        Route::post('order', 'User\SubscriptionController@order')->name('order');
        Route::get('get-plan', 'User\SubscriptionController@getPlan')->name('get_plan');
        Route::get('get-currency-by-gateway', 'User\SubscriptionController@getCurrencyByGateway')->name('get.currency');
        Route::post('cancel', 'User\SubscriptionController@cancel')->name('cancel');
    });

    Route::group(['prefix' => 'referral', 'as' => 'referral.'], function () {
        Route::get('/', 'User\ReferralController@index')->name('index');
    });

    Route::get('market', 'User\HomeController@market')->name('market'); //extra
});
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['auth:admin','permission']], function () {
        ...
        //extra
        Route::get('/facility', 'Admin\ManagePropertyController@facility')->name('facility');
        Route::post('/facility-create', 'Admin\ManagePropertyController@storeFacility')->name('store.facility');
        Route::put('/facility-update/{id}', 'Admin\ManagePropertyController@updateFacility')->name('update.facility');
        ...
        Route::group(['prefix' => 'packages', 'as' => 'packages.'], function () {
            ...
            Route::get('get-info', 'Admin\PackageController@getInfo')->name('get.info'); // ajax
            Route::post('store', 'Admin\PackageController@store')->name('store');
            Route::get('destroy/{id}', 'Admin\PackageController@destroy')->name('destroy');
            Route::get('owner', 'Admin\PackageController@ownerPackage')->name('owner');
        });
...
Route::group(['middleware' => ['Maintenance']], function () {
    ...
    //Route::get('/', 'FrontendController@index')->name('home'); //extra
    Route::get('/about', 'FrontendController@about')->name('about');

    //extra
    Route::get('/how-it-work', 'FrontendController@howitwork')->name('howitwork');
