...
<body <?php if(session()->get('rtl') == 1): ?> class="rtl" <?php endif; ?>>
    ...
    <script>
        ...
        Swal.fire({
            text: "<?php echo app('translator')->get(session('success')); ?>",
            icon: "success"
        });
    </script>
    <?php endif; ?>
    ...
    <script>
        ...
        Swal.fire({
            text: "<?php echo app('translator')->get(session('error')); ?>",
            icon: "error"
        });
    </script>
    <?php endif; ?>
    ...
    <script>
        ...
        Swal.fire({
            text: "<?php echo app('translator')->get(session('warning')); ?>",
            icon: "warning"
        });
    </script>
    <?php endif; ?>
...
</html><?php /**PATH /home/myprexnd/test.mypropertree.co.uk/resources/views/themes/original/layouts/user.blade.php ENDPATH**/ ?>