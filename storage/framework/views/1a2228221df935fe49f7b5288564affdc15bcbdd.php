            ...
            <div class="navbar-brand">
                <a href="<?php echo e(url('/')); ?>">
                    ...
                    <span class="logo-text">
                        <img src="<?php echo e(getFile(config('location.logoIcon.path').'admin-logo.png' )); ?>" alt="homepage"
                             class="dark-logo"/>
                        <img src="<?php echo e(getFile(config('location.logoIcon.path').'admin-logo.png' )); ?>" class="light-logo"
                             alt="homepage"/>
                    </span>
                </a>
            </div>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('admin.profile')); ?>">
                            <i class="svg-icon mr-2 ml-1 icon-user color-primary"></i>
                            <?php echo app('translator')->get('Profile'); ?>
                        </a>

                        <a class="dropdown-item" href="<?php echo e(route('admin.password')); ?>">
                            <i class="svg-icon mr-2 ml-1 icon-settings color-secondary"></i>
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('admin.logout')); ?>"
                           onclick="event.preventDefault();
                                ...
                                data-feather="power" class="svg-icon mr-2 ml-1 text-purple"></i>
...
<?php /**PATH /home/myprexnd/test.mypropertree.co.uk/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>