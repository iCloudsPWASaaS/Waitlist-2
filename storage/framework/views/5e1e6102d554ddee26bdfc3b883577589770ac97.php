        ...
        <div class="main row">
            ...
            <div class="col">
                <div class="header-text-full">
                    <h3 class="dashboard_breadcurmb_heading mb-1"><?php echo app('translator')->get('Properties'); ?></h3>
                    ...
                    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <!--<button class="nav-link btn-custom <?php echo e(($type == 'investment-properties') ? 'active':''); ?>"
                                    ...
                                    aria-selected="true"><?php echo app('translator')->get('Available'); ?></button>-->

                            <a class="nav-link nav-pill-custom <?php echo e(($type == 'investment-properties') ? 'active':''); ?>"  href="<?php echo e(route('user.propertyMarket', 'investment-properties')); ?>"><?php echo app('translator')->get('Available'); ?></a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <!--<button
                                class="nav-link btn-custom <?php echo e(($type == 'issued-properties') ? 'active':''); ?>"
                                ...
                                aria-selected="false"><?php echo app('translator')->get('Issued'); ?></button>-->

                                <a class="nav-link nav-pill-custom <?php echo e(($type == 'issued-properties') ? 'active':''); ?>"  href="<?php echo e(route('user.propertyMarket', 'issued-properties')); ?>"><?php echo app('translator')->get('Issued'); ?></a>
                        </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade <?php echo e(($type == 'investment-properties') ? 'show active':''); ?>" id="pills-all"
                     ...
                     tabindex="0">
                    <?php echo $__env->make($theme.'user.property.allProperty', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- propertyBox -->
                </div>

                <div class="tab-pane fade <?php echo e(($type == 'issued-properties') ? 'show active':''); ?>" id="pills-all"
                     role="tabpanel" aria-labelledby="pills-all-tab"
                     tabindex="0">
                    <?php echo $__env->make($theme.'user.property.sellshareProperty', ['page_tab' => 'issued'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <!-- propertyBox2 -->
                </div>



                <div class="tab-pane fade <?php echo e(($type == 'sold-properties') ? 'show active':''); ?>" id="pills-all"
                     role="tabpanel" aria-labelledby="pills-all-tab"
                     tabindex="0">
                     <?php echo $__env->make($theme.'user.property.sellshareProperty', ['page_tab' => 'sold'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<!--extra-->
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myprexnd/test.mypropertree.co.uk/resources/views/themes/original/user/property/index.blade.php ENDPATH**/ ?>