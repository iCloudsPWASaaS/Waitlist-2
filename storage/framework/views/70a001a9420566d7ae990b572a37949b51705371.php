...
<head>
    ...
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"> --> <!-- extra -->
...
<!--extra-->
<!-- <?php if(in_array(request()->route()->getName(),['register','login'])): ?>
<style>
body {
    background: #189ad3;
}
...
<header id="header-section">
    <div class="overlay">
        <!-- TOPBAR -->
        <?php if(!in_array(request()->route()->getName(),['register','login'])): ?> <!--extra-->
...
<!-- extra -->
<?php echo e(CookieConsent::getCookieConsentPopup()); ?>

</body>

</html><?php /**PATH /home/myprexnd/join.mypropertree.co.uk/resources/views/themes/original/layouts/app.blade.php ENDPATH**/ ?>