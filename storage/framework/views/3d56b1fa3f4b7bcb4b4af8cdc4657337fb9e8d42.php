                ...
                <?php if(adminAccessRoute(config('role.manage_property.access.view'))): ?>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i class="fa fa-building text-success"></i>
                            <span class="hide-menu"><?php echo app('translator')->get('Property Settings'); ?></span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?php echo e(route('admin.facility')); ?>" aria-expanded="false">
                                    <i class="fa fa-check-circle text-primary" aria-hidden="true"></i>
                                    <span class="hide-menu"><?php echo app('translator')->get('Facility List'); ?></span>
                                </a>
                            </li>
                        </ul>
                    </li>
...
<!--extra--><?php /**PATH /home/myprexnd/test.mypropertree.co.uk/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>