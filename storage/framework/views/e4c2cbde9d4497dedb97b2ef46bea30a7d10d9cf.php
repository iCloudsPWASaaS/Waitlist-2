...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group col-sm-3 col-12"> <!-- extra -->
                        <label class="text-dark"><?php echo app('translator')->get('Annual investment limit'); ?></label>
                        <div class="input-group mb-3">
                            <input type="text" name="annual_investment_limit" value="<?php echo e(old('annual_investment_limit') ?? $control->annual_investment_limit ?? '0'); ?>"
                                   required="required" class="form-control ">
                        ...
                        <?php $__errorArgs = ['annual_investment_limit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myprexnd/test.mypropertree.co.uk/resources/views/admin/basic-controls.blade.php ENDPATH**/ ?>