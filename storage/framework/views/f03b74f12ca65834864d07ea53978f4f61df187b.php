        ...
        <div class="container">
            <div class="row gy-5 gy-lg-0">
                ...
                <div class="col-lg-3 col-md-6">
                    <!--extra-->
                    <div class="footer-box">
                        <h5 style="color: white;"><?php echo e(trans('Useful Links')); ?></h5>
                        <ul>
                            <li>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-box">
                        <h5 style="color: white;"><?php echo app('translator')->get('Contact Us'); ?></h5>
                        <ul>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-box">
                        <h5 style="color: white;"><?php echo app('translator')->get('Follow Us'); ?></h5>
...
</footer><?php /**PATH /home/myprexnd/join.mypropertree.co.uk/resources/views/themes/original/partials/footer.blade.php ENDPATH**/ ?>