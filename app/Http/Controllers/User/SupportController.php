...
class SupportController extends Controller
{
    ...
    public function index()
    {
        ...
        $tickets = Ticket::where('user_id', $this->user->id)->withTrashed()->latest()->paginate(config('basic.paginate'));
    ...
    public function ticketView($ticketId)
    {
        ...
        $ticket = Ticket::where('ticket', $ticketId)->withTrashed()->latest()->with('messages')->firstOrFail();
        $user = $this->user;
