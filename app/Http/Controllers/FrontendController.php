...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['featureProperties'] = ManageProperty::with(['details', 'getAddress.details', 'getInvestment'])->withCount('getReviews')->where('status', 1)->where('is_featured', 1)->inRandomOrder()->limit(3)->orderBy('start_date')->get();
        $data['latestProperties'] = ManageProperty::with(['details', 'getAddress.details', 'getInvestment'])->withCount('getReviews')->where('status', 1)->latest()->limit(6)->orderBy('start_date')->get();
    ...
    public function blog()
    {
        ...
        //extra
        $slug = "all";
        return view($this->theme . 'blog', $data, compact('slug'));
    }
    ...
    public function propertyDetails($title = null, $id = null)
    {
        ...
        $data['latestProperties'] = ManageProperty::with('details', 'getAddress.details')->where('status', 1)->inRandomOrder()->limit(3)->orderBy('start_date')->get();
        if (Auth::check() == true) {
    ...
    public function property(Request $request, $type = null, $id = null)
    {
        ...
        $data['properties'] = ManageProperty::with(['details', 'getAddress.details', 'getInvestment', 'getReviews'])->withCount('getReviews')
            ...
            ->where('status', 1)
            //->whereDate('expire_date','>',now()) //extra
    ...
    //extra
    public function join($sponsor = null) //extra
    {
        //dd($sponsor);
    ...
    public function joinStore(Request $request) //extra
    {
