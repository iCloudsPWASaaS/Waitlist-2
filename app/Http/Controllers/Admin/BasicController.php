...
class BasicController extends Controller
{
    ...
    public function currencyExchangeApiConfig(Request $request)
    {
        ...
        if ($request->isMethod('get')) {
            ...
            config(['basic.currency_layer_access_key' => $purifiedData['currency_layer_access_key']]);
            config(['basic.currency_layer_auto_update' => $purifiedData['currency_layer_auto_update']]);
            config(['basic.currency_layer_auto_update_at' => $purifiedData['currency_layer_auto_update_at']]);
            config(['basic.coin_market_cap_app_key' => $purifiedData['coin_market_cap_app_key']]);
            config(['basic.coin_market_cap_auto_update' => $purifiedData['coin_market_cap_auto_update']]);
            config(['basic.coin_market_cap_auto_update_at' => $purifiedData['coin_market_cap_auto_update_at']]);
    ...
    public function updateConfigure(Request $request)
    {
        ...
        $configure->annual_investment_limit = (int) $reqData['annual_investment_limit']; //extra
