...
class InvestmentService
{
    ...
    public function forAllInvest($user, $property, $amount, $pay_installment, $trx, $reserve = false) //extra $reserve
    {
        ...
        if (($property->fixed_amount != null && ($property->fixed_amount == $amount || $property->available_funding == $amount)) && $pay_installment == null) {
            $investStatus = $reserve ? 4 : 1;
            $is_installment = 0;
            BasicService::makeInvest($user, $property, $amount, $net_profit, $net_loss, $investStatus, $is_installment, $trx, $reserve);
