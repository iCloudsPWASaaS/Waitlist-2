$(document).on('click', '.investNow', function () {
    ...
    $('.property-id').val(property.id); //extra
...
$(document).on('click', '.investNowExtra', function () {
    ...
    axios.post(dataRoute, {
        amount: availableFunding
    })
        .then(function (response) {
            //console.log(response.data.success)
            /* if (response.data.status == 'success') {
                Notiflix.Notify.Success("investment added into cart successfully");
            } */
            ...
            $(".item-in-cart-count").removeClass("d-none");
            $(".item-in-cart-count").html(Number($(".item-in-cart-count").html()) + 1);
            console.log(Number($(".item-in-cart-count").html()));
        })
...
$(document).on('click', '.reserveNowExtra', function () {
