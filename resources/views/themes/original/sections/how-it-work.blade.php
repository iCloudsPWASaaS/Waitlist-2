@if(isset($templates['how-it-work'][0]) && $aboutUs = $templates['how-it-work'][0])
<!-- about section -->

@if(request()->route()->getName() == "howitwork")
        ...
        <div class="row gy-5 g-lg-5">
            ...
            <div class="row">
                <div class="col-lg-12 pt-4 pt-lg-0">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <img src="{{getFile(config('location.content.path').$aboutUs->templateMedia()->image1)}}" style="height: 540px; width: 500px">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-8">
                            <img src="{{getFile(config('location.content.path').$aboutUs->templateMedia()->image2)}}" style="height: 400px; width: 300px">
                        </div>


                        <!-- <div class="col-md-6">
                            <a class="btn btn-custom btn text-white" href="{{ route('howitwork') }}">@lang('Discover More')</a>
                        </div> -->

                        <div class="col-md-12">
                            <p><b>Still have questions? Check out our <a href="{{route('faq')}}">FAQ's</a></b></p>
                        </div>
                    </div>
                </div>
            </div>
