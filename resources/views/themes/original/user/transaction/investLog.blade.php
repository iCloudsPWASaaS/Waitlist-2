                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="company-logo" data-label="@lang('Property')">
                                <div>
                                    <a href="{{ route('user.propertyDetails',[@slug(optional($invest->property->details)->property_title), optional($invest->property)->id]) }}" target="_blank">
                                        <img src="{{ getFile(config('location.propertyThumbnail.path').optional($invest->property)->thumbnail) }}">
                                    </a>
                                </div>
                                <div>
                                    <a href="{{ route('user.propertyDetails',[@slug(optional($invest->property->details)->property_title), optional($invest->property)->id]) }}" target="_blank">@lang(\Illuminate\Support\Str::limit(optional($invest->property->details)->property_title, 30))</a> <br>
