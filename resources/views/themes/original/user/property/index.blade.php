        ...
        <div class="main row">
            ...
            <div class="col">
                <div class="header-text-full">
                    <h3 class="dashboard_breadcurmb_heading mb-1">@lang('Properties')</h3>
                    ...
                    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <!--<button class="nav-link btn-custom {{($type == 'investment-properties') ? 'active':''}}"
                                    ...
                                    aria-selected="true">@lang('Available')</button>-->

                            <a class="nav-link nav-pill-custom {{($type == 'investment-properties') ? 'active':''}}"  href="{{ route('user.propertyMarket', 'investment-properties') }}">@lang('Available')</a>
                        </li>

                        <li class="nav-item" role="presentation">
                            <!--<button
                                class="nav-link btn-custom {{($type == 'issued-properties') ? 'active':''}}"
                                ...
                                aria-selected="false">@lang('Issued')</button>-->

                                <a class="nav-link nav-pill-custom {{($type == 'issued-properties') ? 'active':''}}"  href="{{ route('user.propertyMarket', 'issued-properties') }}">@lang('Issued')</a>
                        </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade {{($type == 'investment-properties') ? 'show active':''}}" id="pills-all"
                     ...
                     tabindex="0">
                    @include($theme.'user.property.allProperty') <!-- propertyBox -->
                </div>

                <div class="tab-pane fade {{($type == 'issued-properties') ? 'show active':''}}" id="pills-all"
                     role="tabpanel" aria-labelledby="pills-all-tab"
                     tabindex="0">
                    @include($theme.'user.property.sellshareProperty', ['page_tab' => 'issued']) <!-- propertyBox2 -->
                </div>



                <div class="tab-pane fade {{($type == 'sold-properties') ? 'show active':''}}" id="pills-all"
                     role="tabpanel" aria-labelledby="pills-all-tab"
                     tabindex="0">
                     @include($theme.'user.property.sellshareProperty', ['page_tab' => 'sold'])
                </div>
            </div>
        </div>
    </div>
