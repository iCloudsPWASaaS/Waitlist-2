       ...
       <div class="row ms-2 mt-4 mb-2">
           <div class="col">
               <div class="header-text-full">
                   <h3 class="dashboard_breadcurmb_heading mb-1">@lang('Deposit')</h3>
                   <nav aria-label="breadcrumb">
                       <ol class="breadcrumb">
                           <li class="breadcrumb-item"><a href="{{ route('user.home') }}">@lang('Dashboard')</a>
                           </li>
                           <li class="breadcrumb-item active" aria-current="page">@lang('Deposit')</li>
                       </ol>
                   </nav>
               </div>
           </div>
...
@push('script')
    ...
    <script>
        ...
        $(".checkCalc").on('click', function () {
            alert("free user condition here")
