                        ...
                        <form action="{{ route('user.mailVerify') }}" method="post">
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    ...
                                    <p>We have sent you an email containing a six digit verification code. Please enter the code in the box provided to complete your registration and get access to our amazing deals.</p>
                                </div>
