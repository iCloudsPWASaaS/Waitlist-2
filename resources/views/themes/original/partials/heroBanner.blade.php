                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-sm-6 col-xs-12">
                            ...
                            <a class="btn btn-custom btn text-white mt-4 mb-4 ms-5" href="{{ route('about') }}">@lang('Start Exploring')</a>
                        </div>
                        <!-- END COL-->
                        <div class="col-lg-6 col-sm-6 col-xs-12">
                            <div class="hero_img">
        ...
        <div class="row h-100">
            <div class="col-lg-4 col-sm-4 col-xs-12 d-flex align-items-center">
                <div class="row">
                    ...
                    <div class="col-12">
                        <a class="btn btn-custom btn text-white mt-4 mb-4" href="{{ route('about') }}">@lang('Learn more')</a>
                    </div>
                </div>
            </div>
