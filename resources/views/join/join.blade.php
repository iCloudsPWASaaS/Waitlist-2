...
<body>
    ...
    <div class="container col-xxl-8 px-4">
        <img src="{{url('assets/join/Logo.png')}}" alt="" class="" />
        ...
        <div class="row flex-lg-row">
            <div class="col-lg-7">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <!-- <form action="{{ route('form.submit') }}" method="POST" class="w-75 fs-5 pb-5" id="waitlistForm2"> -->
                    <form action="{{ route('form.submit') }}" method="POST" class="w-75 fs-5 pb-5" id="waitlistForm2">
                        @csrf
                        ...
                        <input type="hidden" name="username" value="{{ strRandom(6)}}">
            ...
            <div class="col-10 col-sm-8 col-lg-5">
                <img src="{{url('assets/join/Card.png')}}" class="d-block mx-lg-auto img-fluid shadow-lg rounded-3" alt="Bootstrap Themes" width="500" loading="lazy" />
            </div>
        </div>
    </div>
    ...
    <div class="container col-xxl-6 px-4 pt-5">
        ...
        <div class="d-flex justify-content-center align-items-center mb-4  d-none">
            <img src="{{url('assets/join/Trustpilot.png')}}" alt="" width="200" />
        </div>
    </div>
