                                ...
                                <div class="col-md-12">
                                    <ul class="list-style-none">
                                        ...
                                        <li class="my-2 border-bottom pb-3">
                                                <span class="font-weight-medium text-dark"><i class="far fa-building text-success mr-2" aria-hidden="true"></i> {{trans('Property')}}: <small class="float-right"><a href="{{ route('user.propertyDetails',[slug(optional($singleInvestDetails->property->details)->property_title), optional($singleInvestDetails->property)->id]) }}">
