        ...
        <div class="card-body">
            ...
            <form method="post" action="" class="needs-validation base-form">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="text-dark">@lang('Minimum Transfer')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="text-dark">@lang('Maximum Transfer')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="text-dark">@lang('Transfer Charge')</label>
                    ...
                    <div class="form-group col-sm-3 ">
                        <label class="text-dark">@lang('Joining bonus')</label>
                    ...
                    <div class="form-group col-sm-3 col-12">
                        <label class="text-dark">@lang('Bonus Amount')</label>
                        <div class="input-group mb-3">
                    ...
                    <div class="form-group col-sm-3 col-12"> <!-- extra -->
                        <label class="text-dark">@lang('Annual investment limit')</label>
                        <div class="input-group mb-3">
                            <input type="text" name="annual_investment_limit" value="{{ old('annual_investment_limit') ?? $control->annual_investment_limit ?? '0' }}"
                                   required="required" class="form-control ">
