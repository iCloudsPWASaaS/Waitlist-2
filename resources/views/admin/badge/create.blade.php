            ...
            <div class="tab-content mt-2" id="myTabContent">
                @foreach($languages as $key => $language)
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}" role="tabpanel">
                        <form method="post" action="{{route('admin.badgeStore', $language->id)}}" class="mt-4" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
                                    ...
                                    <input type="text" name="rank_name[{{ $language->id }}]"
                                           ...
                                           value="{{ old('rank_name'.'.'.$language->id) }}" placeholder="@lang('rank name')">
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 mb-3">
                                    ...
                                    <input type="text" name="rank_level[{{ $language->id }}]"
                                           ...
                                           value="{{ old('rank_level'.'.'.$language->id) }}" placeholder="@lang('rank level')">
                                ...
                                @if ($loop->index == 0)
                                    <div class="form-group col-md-4 col-lg-4 col-sm-12 fixedAmount d-block">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="min_invest" class="form-control" value="{{ old('min_invest') }}" placeholder="0.00" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                    ...
                                    <div class="form-group col-md-4 col-lg-4 col-12 fixedAmount d-block">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="min_deposit" class="form-control" value="{{ old('min_deposit') }}" placeholder="0.00" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                            <div class="input-group-append">
                                                <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-md-5 fixedAmount d-block">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="min_earning" value="{{ old('min_earning') }}" class="form-control" placeholder="0.00" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                            <div class="input-group-append">
                                                <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group col-md-3 fixedAmount d-block">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="bonus" value="{{ old('bonus') }}" class="form-control" placeholder="0.00">
                                ...
                                <div class=" col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description[{{ $language->id }}]" rows="15" class="form-control summernote @error('description'.'.'.$language->id) is-invalid @enderror" id="summernote" placeholder="@lang('type here..')" value="{{ old('description'.'.'.$language->id) }}">{{old('description'.'.'.$language->id)}}</textarea>
