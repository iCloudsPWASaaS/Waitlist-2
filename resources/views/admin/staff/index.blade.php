...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            @if(adminAccessRoute(config('role.manage_role.access.add')))
                <div class="d-flex justify-content-end mb-2 text-right">
                    <button  data-target="#addModal"  data-toggle="modal"  class="btn btn-primary btn-rounded btn-sm"><i class="fa fa-user-plus"></i> {{trans('Create New')}} </button>
                </div>
            @endif
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        @if(adminAccessRoute(config('role.manage_role.access.edit')))
                    ...
                    @foreach($admins as $k => $data)
                        <tr>
                            ...
                            <td>
                                <span  class="custom-badge  badge-pill  bg-{{ $data->status == 0 ? 'danger' : 'success' }}">{{ $data->status == 0 ? 'Deactive' : 'Active' }}</span>
                            </td>
                            @if(adminAccessRoute(config('role.manage_role.access.edit')))
                                <td data-label="@lang('Action')">
                                    <button
                                        class="edit_button   btn btn-outline-primary btn-rounded btn-rounded btn-sm"
                                    ...
                                    <div class="modal fade" id="myModal{{$data->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                            ...
                                            <div class="modal-content ">
                                                ...
                                                <form role="form" method="POST" class="actionRoute " action="{{route('admin.updateStaff',$data)}}" enctype="multipart/form-data" >
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row permissionInputLebel">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input class="form-control " name="username"
                                                                       placeholder="{{trans('Username')}}" value="{{$data->username}}" autocomplete="off"
                                                                       required>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="text-dark"> {{trans('E-Mail')}} </label>
                                                                <input class="form-control " name="email"
                                                                       placeholder="Email Address" value="{{$data->email}}" autocomplete="off"
                                                                       required>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="text-dark"> {{trans('Phone')}} </label>
                                                                <input class="form-control " name="phone"
                                                                       placeholder="{{trans('Mobile Number')}}" value="{{$data->phone}}" autocomplete="off"
                                                                       required>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input type="password" name="password" value="{{ bcrypt($data->password) }}" placeholder="Password" autocomplete="off"
                                                                       class="form-control" >
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <div class="card m-0">
                                                                    ...
                                                                    <div class="card-body select-all-access pb-0">
                                                                        <div class="form-group">
                                                                            <label><input type="checkbox" class="selectAll mr-1" name="accessAll"> {{trans('Select All')}}</label>
                                                                        </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-danger btn-rounded" data-dismiss="modal">@lang('Close')</button>
                                                        <button type="submit" class="btn btn-primary btn-rounded" >@lang('Update')</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content ">
                ...
                <form role="form" method="POST" class="actionRoute" action="{{route('admin.storeStaff')}}" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger btn-rounded" data-dismiss="modal">@lang('Close')</button>
                        <button type="submit" class="btn btn-primary btn-rounded" >@lang('Save')</button>
                    </div>
