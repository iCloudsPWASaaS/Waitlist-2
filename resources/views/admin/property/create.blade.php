    ...
    <div class="card-body">
        ...
        <div class="tab-content mt-4" id="myTabContent">
            ...
            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}" role="tabpanel">
                <form method="post" action="{{route('admin.propertyStore', $language->id)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-header text-primary">
                            <span class="propertyDetailsLabel">@lang('Add Property Details')</span>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="property_title[{{ $language->id }}]" value="{{ old('property_title'.'.'.$language->id) }}" placeholder="@lang('Property title')" class="form-control @error('property_title'.'.'.$language->id) is-invalid @enderror">
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <select name="address_id" class="form-control  type addressList">
                                            ...
                                            <option value="{{ $address->id }}" {{ old('address_id') == $address->id ? 'selected' : '' }}>@lang(optional($address->details)->title)</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    @error('address_id')
                                ...
                                <div class="col-md-3 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" value="{{old('location')}}" placeholder="@lang('only embed url accepted')" class="form-control @error('location') is-invalid @enderror">
                                        @error('location')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3 col-xl-3">
                                    ...
                                    <select name="amenity_id[]" class="form-control propertyAmenities @error('amenity_id') is-invalid @enderror" multiple>
                                        <option disabled>@lang('Choose items')</option>
                                        @foreach($allAmenities as $amenity)
                                        <option value="{{ $amenity->id }}" {{ in_array($amenity->id, (array) old('amenity_id')) ? 'selected' : '' }}>@lang(optional($amenity->details)->title)</option>
                                        @endforeach
                                    </select>
                                    @error('amenity_id')
                                ...
                                <div class="col-md-6 col-xl-6">
                                    ...
                                    <select name="facility_id[]" class="form-control propertyAmenities @error('facility_id') is-invalid @enderror" multiple>
                                        ...
                                        <option value="{{ $facility->id }}" {{ in_array($facility->id, (array) old('facility_id')) ? 'selected' : '' }}>{{ $facility->title }}</option>
                                        @endforeach
                                    </select>
                                    @error('facility_id')
                                    <span class="text-danger">@lang($message)</span>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="property_tags" value="{{old('property_tags')}}" placeholder="@lang('Property Tags')" class="form-control @error('property_tags') is-invalid @enderror" data-role="tagsinput">
                                        @error('property_tags')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-12 col-xl-12 property__details col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote @error('details'.'.'.$language->id) is-invalid @enderror" name="funding_timeline[{{ $language->id }}]" id="summernote" rows="15" value="{{ old('funding_timeline'.'.'.$language->id) }}">{{old('funding_timeline'.'.'.$language->id)}}</textarea>
                                        @error('funding_timeline'.'.'.$language->id)
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-xl-12 property__details col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control summernote @error('details'.'.'.$language->id) is-invalid @enderror" name="details_other[{{ $language->id }}]" id="summernote" rows="15" value="{{ old('details_other'.'.'.$language->id) }}">{{old('details_other'.'.'.$language->id)}}</textarea>
                                        @error('details_other'.'.'.$language->id)
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='hidden' value='1' name="is_featured" {{ old('is_featured') == "1" ? 'checked' : ''}}>
                                            <input type="checkbox" name="is_featured" id="is_featured" class="custom-switch-checkbox" value="0" {{ old('is_featured') == "0" ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-switch-btn">
                                            <input type='text' value='{{ old('property_no') }}' name="property_no" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-xl-3">
                                    <div class="form-group">
                                        ...
                                        <!-- <select name="property_type"
                                                            class="form-control property_type" id="property_type">
                                                                <option value="">@lang('Choose items')</option>
                                                                <option value="hmo" @if (old('property_type') == "hmo") {{ 'selected' }} @endif>HMO</option>
                                                                <option value="btl" @if (old('property_type') == "btl") {{ 'selected' }} @endif>BTL</option>
                                                                <option value="sh" @if (old('property_type') == "sh") {{ 'selected' }} @endif>SH</option>
                                                                <option value="sa" @if (old('property_type') == "sa") {{ 'selected' }} @endif>SA</option>
                                                                <option value="development" @if (old('property_type') == "development") {{ 'selected' }} @endif>Development</option>
                                                                <option value="flipp" @if (old('property_type') == "flipp") {{ 'selected' }} @endif>Flipp</option>
                                                                <option value="auction" @if (old('property_type') == "auction") {{ 'selected' }} @endif>Auction</option>
                                                                <option value="commercial" @if (old('property_type') == "commercial") {{ 'selected' }} @endif>Commercial</option>
                                                                <option value="mix" @if (old('property_type') == "mix") {{ 'selected' }} @endif>Mix</option>
                                                                <option value="residential" @if (old('property_type') == "residential") {{ 'selected' }} @endif>Residential</option>
                                                                <option value="development" @if (old('property_type') == "development") {{ 'selected' }} @endif>Holiday</option>
                                                    </select> -->
            ...
            <div class="card">
                <div class="card-header text-primary">
                    <span class="propertyDetailsLabel">Add Card Details</span>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <select name="type_of_deal" class="form-control property_type" id="type_of_deal">
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="property_value" id="property_value" class="form-control @error('property_value') is-invalid @enderror" placeholder="0.00" value="{{ old('property_value') }}">
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="rental_income" id="rental_income" class="form-control @error('rental_income') is-invalid @enderror" placeholder="0.00" value="{{ old('rental_income') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="rental_income_gross" id="rental_income_gross" class="form-control @error('rental_income_gross') is-invalid @enderror" placeholder="0.00" value="{{ old('rental_income_gross') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="custom-switch-btn">
                                    <input type='hidden' value='0' name="is_invest_type" {{ old('is_invest_type') == "0" ? 'checked' : '' }}>
                                    <input type="checkbox" name="is_invest_type" id="is_invest_type" class="custom-switch-checkbox" value="1" {{ old('is_invest_type') == "1" ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-xl-3 fixedAmount  {{ old('is_invest_type') == "1" ? 'd-none' : '' }}">
                            <div class="form-group">
                                <label>Property Card Price <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" name="fixed_amount" class="form-control @error('fixed_amount') is-invalid @enderror" placeholder="0.00" value="{{ old('fixed_amount') }}" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')" id="fixedAmount" autocomplete="off">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3 rangeAmount d-none {{ old('is_invest_type') == "1" ? 'd-block' : 'd-none' }}">
                            <div class="form-group">
                                <label>Property Card Price (Min) <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="text" name="minimum_amount" class="form-control @error('minimum_amount') is-invalid @enderror" placeholder="0.00" value="{{ old('minimum_amount') }}" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3 rangeAmount d-none {{ old('is_invest_type') == "1" ? 'd-block' : 'd-none' }}">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="maximum_amount" name="maximum_amount" class="form-control @error('maximum_amount') is-invalid @enderror" placeholder="0.00" value="{{ old('maximum_amount') }}" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="property_yield" id="property_yield" class="form-control @error('property_yield') is-invalid @enderror" placeholder="0.00" value="{{ old('property_yield') }}">
                                    <div class="input-group-append">
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="rental_income_est" id="rental_income_est" class="form-control @error('rental_income_est') is-invalid @enderror" placeholder="0.00" value="{{ old('rental_income_est') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="profit" class="form-control @error('profit') is-invalid @enderror" placeholder="0.00" value="{{ old('profit') }}" onkeyup="this.value = this.value.replace (/^\.|[^\d\.]/g, '')">
                                    <span class="input-group-text">%</span>
                                </div>
                                @error('profit')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="roi_month" id="roi_month" class="form-control @error('roi_month') is-invalid @enderror" placeholder="" value="{{ old('roi_month') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <select name="how_many_days" id="how_many_days" class="form-control @error('how_many_days') is-invalid @enderror">
                                    ...
                                    <option value="{{ $schedule->id }}" {{ old('how_many_days')  == $schedule->id ? 'selected' : ''}}>@lang($schedule->time) @lang($schedule->time_type)</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('how_many_days')
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="custom-switch-btn">
                                    <input type='hidden' value='1' name="is_investor" {{ old('is_investor') == "1" ? 'checked' : ''}}>
                                    <input type="checkbox" name="is_investor" id="is_investor" class="custom-switch-checkbox" value="0" {{ old('is_investor') == "0" ? 'checked' : '' }}>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group ">
                                ...
                                <div class="custom-switch-btn">
                                    ...
                                    <input type="checkbox" name="status" class="custom-switch-checkbox" id="status" value="0" {{ old('status') == "0" ? 'checked' : '' }}>
                        ...
                        <!-- <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="card_issued" class="form-control @error('card_issued') is-invalid @enderror" placeholder="0" value="{{ old('card_issued') }}">
                                </div>
                                @error('card_issued')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="purchase_price" id="purchase_price" class="form-control @error('purchase_price') is-invalid @enderror" placeholder="0.00" value="{{ old('purchase_price') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="capital_appreciation" id="capital_appreciation" class="form-control @error('capital_appreciation') is-invalid @enderror" placeholder="0.00" value="{{ old('capital_appreciation') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="development_cost" id="development_cost" class="form-control @error('development_cost') is-invalid @enderror" placeholder="0.00" value="{{ old('development_cost') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="service_charges" id="service_charges" class="form-control @error('service_charges') is-invalid @enderror" placeholder="0.00" value="{{ old('service_charges') }}">
                                    <div class="input-group-append">
                                        <span class="input-group-text">@lang(config('basic.currency_symbol'))</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="maintenance" id="maintenance" class="form-control @error('maintenance') is-invalid @enderror" placeholder="" value="{{ old('maintenance') }}">
                                <!-- <select name="maintenance" class="form-control" id="maintenance">
                                    <option value="0">Outsourced</option>
                        ...
                        <div class="col-md-3 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="user_card_limit" id="user_card_limit" class="form-control @error('user_card_limit') is-invalid @enderror" placeholder="" value="{{ old('user_card_limit') }}">
                            </div>
                        </div>
